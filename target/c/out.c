...
int*c = &Vc;
 ...
 if (*c == CTRL_KEY('q'))
 {
  ...
  else
  {
   ...
   YdnK();
   sf.pos=4026607;
   Zexit(Ypp_a(NULL, ((Tc*)&Ya_Da), 812, 7), 0);
  }
 }
 else {
 sf.pos=4026608;
...
Tc *Y4Sa() {
 ...
 sf.pos=2570802;
 VstatText = ZcS8(((Tc*)&Y7), ZintAsString(Vec->Vmode), ((Tc*)&Y2pU), (t0 = Zint2string((Vec->Vcy + 1))), ((Tc*)&YV), (t2 = Zint2string((Vec->Vn_erows + 1))), ((Tc*)&YJ7Q), (t4 = Zint2string((Vec->Vcx + 1))));
 sf.pos=2570803;
