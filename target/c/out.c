...
Zs74 YfXk = {"\110('.') | i was trying to find something, but you just canceled the thing.\000"};
...
void YYfE(Tc *Aquery, Ti Ak) {
 ...
 sf.pos=3376303;
 {
  ...
  Ti Vmatch;
  sf.pos=3376304;
  Vr = ((Ys45 *)ZListGetPtr(Vec->Verows, Vi));
  sf.pos=3376305;
...
int*c = &Vc;
 ...
 if (*c == CTRL_KEY('q'))
 {
  ...
  else
  {
   ...
   YdnK();
   sf.pos=4026607;
   Zexit(Ypp_a(NULL, ((Tc*)&Ya_Da), 646, 7), 0);
  }
 }
 else
 {
